...
class MockClass2 : public llist {
    public:
        MOCK_METHOD(int, read_file, ());
        MOCK_METHOD(int, add_record, (std::string, std::string, int, std::string));
        MOCK_METHOD(int, print_record, (std::string));
        MOCK_METHOD(int, write_file, ());
